...
ReactDOM.render(React.createElement(settings_1.Settings, null), document.getElementById("settings-app"));
...
var Settings = /** @class */ (function (_super) {
    ...
    Settings.prototype.getLogin = function () {
        var _this = this;
        services.getLogin({
    ...
    Settings.prototype.changeLogin = function (value) {
        this.setState({
            examinator: __assign({}, this.state.examinator, { value: value })
        });
    };
    Settings.prototype.changePass = function (value) {
        this.setState({
            examPass: __assign({}, this.state.examPass, { value: value })
        });
    };
    Settings.prototype.resetPass = function () {
        this.setState({
            examPass: __assign({}, this.state.examPass, { value: "" })
        });
    };
    Settings.prototype.saveLogin = function () {
        var _this = this;
        services.saveLogin({
    ...
    Settings.prototype.savePass = function () {
        var _this = this;
        services.savePass({
...
Object.defineProperty(exports, "__esModule", { value: true });
var load_1 = __webpack_require__(5);
var dir = "../wp-content/plugins/referee-testing/api/settings/";
exports.getLogin = function (contract) {
...
exports.saveLogin = function (contract) {
    return load_1.runAjax({
...
exports.savePass = function (contract) {
    return load_1.runAjax({
